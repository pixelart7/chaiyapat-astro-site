...
{#if isShow}
  <li>
    ...
    <div class="flex text-sm font-medium gap-1">
      <button class="h-6 flex items-center justify-center p-1 bg-gray-100 hover:bg-primary-500/10 rounded overflow-hidden" on:click={() => onClickCopy()}>
      ...
      <button class="h-6 flex items-center justify-center p-1 bg-gray-100 hover:bg-primary-500/10 rounded" on:click={() => onClickShare()}>
